...
import { TestBriefingButton } from "@/components/settings/test-briefing-button";
...
export default async function SettingsPage() {
  ...
  // 🔒 Only SUPER_ADMIN and MANAGER can access settings
  if (!userRole || !canManageTeam(userRole)) {
    redirect("/");
  }
  const [auditLogs, team, firmSettings] = await Promise.all([
    getAuditLogs(),
    getTeamMembers(),
    getFirmSettings(),
  ]);
  ...
  const formatDetails = (details: unknown) => {
    ...
    return (
      String(details).slice(0, 50) + (String(details).length > 50 ? "..." : "")
    );
  };
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general">
        <TabsList>
          ...
          <TabsTrigger value="firm" data-testid="firm-tab">
            Firm Profile
          </TabsTrigger>
        ...
        <TabsContent value="general">
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Manage automated system tasks and email notifications.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Manually trigger the daily briefing email for testing
                    purposes.
                  </p>
                </div>
                <TestBriefingButton />
        ...
        <TabsContent value="firm">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your law firm&apos;s branding and contact details. These
                settings are used in all generated legal documents.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <FirmSettingsForm
        ...
        <TabsContent value="team">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your staff members and access roles.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <TeamManager members={team} canManage={canManageTeam(userRole)} />
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            <CardHeader className="flex flex-row items-start justify-between space-y-0">
              <div className="space-y-1.5">
                ...
                <CardDescription>
                  System Activity Log - Last 50 operations recorded for audit
                  compliance.
                </CardDescription>
              </div>
              <ExportButton />
