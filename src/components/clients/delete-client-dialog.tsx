...
import { deleteClient } from "@/server/actions/data-privacy";
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("Client deleted successfully", {
        description: "All data has been permanently removed. Audit log preserved for compliance.",
        duration: 5000,
      });
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-base leading-relaxed pt-2">
            ...
            <span className="font-semibold text-foreground">{clientName}</span> and remove their
        ...
        <div className="space-y-4 py-4">
          <div className="rounded-lg border border-destructive/50 bg-destructive/5 p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 ml-6 list-disc">
              ...
              <li>Cannot delete if client owns properties</li>
              <li>Audit logs will be preserved for legal compliance</li>
              <li>This action fulfills NDPR Right to Erasure</li>
            </ul>
          </div>
